...
{
    [SerializeField] private AudioMixer audioMixer; //ミキサー
    [SerializeField] private AudioSource BGMaudioSource; //オーディオソース
    [SerializeField] private AudioSource SEaudioSource; //オーディオソース
    [SerializeField] private AudioClip se1; //SE
    [SerializeField] private Slider bgmSlider; //BGMスライダー
    [SerializeField] private Slider seSlider; //SEスライダー
    [SerializeField] private Toggle BGM_toggle; //BGMトグル
    [SerializeField] private Toggle SE_toggle; //SEトグル
    [SerializeField] private Text option_text; //テキスト
